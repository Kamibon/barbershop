...
const FailedToast = (props: Props) => {
  const { title, open, onClose } = props;
  if (open)
    return (
      <div className="flex items-center justify-between max-w-80 w-full bg-red-600/20 text-red-600 px-3 h-10 rounded fixed top-10 right-10">
