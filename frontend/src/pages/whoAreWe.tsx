    ...
    <div className="flex flex-col p-4">
      ...
      <div className=" flex flex-col md:flex-row gap-4 mt-6">
        ...
        <div className="flex flex-col gap-2 p-4">
          ...
          <span className="text-[#2B2B2B] text-base lg:text-lg">
      ...
      <div className=" flex flex-col md:flex-row-reverse gap-4 mt-6">
        ...
        <div className="flex flex-col gap-2 p-4">
          ...
          <span className="text-[#2B2B2B] text-base lg:text-lg">
           ...
           Perfetto per chi vuole un look alla moda o un tocco unico. 
           La sua attenzione ai dettagli è ciò che rende ogni taglio impeccabile.
          </span>
        </div>
      </div>
      <div className=" flex flex-col md:flex-row gap-4 mt-6">
        ...
        <div className="flex flex-col gap-2 p-4">
          ...
          <span className="text-[#2B2B2B] text-base lg:text-lg">
            ...
            Con pazienza e precisione, offre un’esperienza rilassante e rigenerante per chi ama 
            prendersi cura di barba e viso.
          </span>
        </div>
      </div>
    </div>
