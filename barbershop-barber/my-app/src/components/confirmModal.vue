<template>
  ...
  >
    <div
      class="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-5 md:w-115 w-92.5 border border-gray-200 fade-enter-active fade-leave-active"
    ...
    >
      ...
      <h2 id="modal-title" class="text-gray-900 font-semibold mt-4 text-xl">
        Sei sicuro?
      </h2>
