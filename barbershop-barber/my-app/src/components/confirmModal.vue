<template>
    <div v-if="isOpen" class="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50"
        @click.self="() => onDeny()">
        <div class="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-5 md:w-115 w-92.5 border border-gray-200 fade-enter-active fade-leave-active"
            ...
            <h2 id="modal-title" class="text-gray-900 font-semibold mt-4 text-xl">Sei sicuro?</h2>
            <p id="modal-description" class="text-sm text-gray-600 mt-2 text-center">
            ...
            <div class="flex items-center justify-center gap-4 mt-5 w-full">
                <button @click="() => onDeny()" type="button"
